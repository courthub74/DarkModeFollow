// First, we get the current theme from LocalStorage
let darkmode = localStorage.getItem('darkmode');

// Query the Theme Switch button
const themeSwitch = document.getElementById('theme_switcher');
...
themeSwitch.addEventListener('click', () => {
    ...
    // conditional if darkmode is active or not
        // then enable Dark or disable Dark accordingly
            // then ABOVE define the functions to do so
